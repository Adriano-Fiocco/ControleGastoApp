...
namespace ControleGastoAppData.Dao
{
    public class DespesaDao : BancodadosDao 
    {
        public bool IncluirDespesa(Despesa despesa)
        {
            ...
            string sql = "Insert into despesa (codPessoa, tipoDespesa, valorDespesa) " +
                "                     Values(@codPessoa, @tipoDespesa, @valorDespesa);";
        ...
        public DataSet ListaDespesa(int codDespesa)
        {
            ...
            string sql = 
                ...
                "valorDespesa as 'Valor da despesa' from despesa, pessoa" +
