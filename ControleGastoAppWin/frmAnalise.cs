...
namespace ControleGastoAppWin
{
    public partial class frmAnalise : Form
    {
        ...
        private void PreencherReceita() 
        {
            ...
            dgvReceita.DataSource =  receitaDao.ObtemReceitaDaPessoa(PegarCodigoCBX());
        ...
        private void PreencherDespesa()
        {
            ...
            dgvDespesa.DataSource = despesaDao.ObtemDespesaDaPessoa(PegarCodigoCBX());
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            if (total >= 0)
            {
                lblTotalSaldo.Text = total.ToString();
