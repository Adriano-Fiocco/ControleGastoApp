...
select receita.valorRenda as 'Valor da Renda', receita.tipoRenda as 'Receita' from receita where receita.codPessoa = 11;
...
Delete pessoa, despesa, receita
from pessoa
inner join despesa on despesa.codPessoa = pessoa.codPessoa 
inner join receita on receita.codPessoa = pessoa.codPessoa
where codPessoa = @codPessoa
delete from receita where 